...
export function AuthProvider({ children, initialUser }: AuthProviderProps) {
   ...
   *
   * Always navigate a full document: `/` may belong to the personal-site zone.
   * This also discards React state and in-flight subscriptions when Gateway
   * logout fails, matching the legacy form-POST logout behavior.
   */
